...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col md:flex-row bg-background overflow-hidden font-sans">
      {/* Right Side: Cinematic Narrative (Swapped order for variety) */}
        ...
        <div className="relative z-20 max-w-lg space-y-12 animate-in fade-in slide-in-from-right-8 duration-1000">
          <div className="space-y-4">
             ...
             <h2 className="text-6xl md:text-8xl font-black text-white tracking-tighter italic font-serif leading-none">
                UNLOCK <br/> <span className="text-accent">EXCLUSIVE</span> <br/> ACCESS.
             </h2>
          </div>
          
          <ul className="space-y-6">
            {[
              "Priority access to new Series drops",
              "Exclusive lab results & batch tracking",
              "Wholesale tier eligibility",
              "Express checkout & order history"
            ].map((feature, i) => (
          ...
          <div className="bg-white/5 backdrop-blur-3xl p-8 rounded-[2.5rem] border border-white/10">
             <p className="text-sm font-medium text-white/60 italic leading-relaxed">
               "Switching to Sharcly changed my morning routine. The focus and clarity are unmatched. Best decision for my daily wellness."
             </p>
      ...
      <div className="flex-1 flex items-center justify-center p-6 md:p-12 relative">
        ...
        <div className="w-full max-w-md space-y-12 animate-in fade-in slide-in-from-left-8 duration-1000">
          <div className="space-y-4">
             ...
             <h1 className="text-4xl md:text-5xl font-black tracking-tighter text-foreground leading-[0.9]">START YOUR <br/> JOURNEY.</h1>
             <p className="text-foreground/50 font-medium tracking-tight">Create your premium account in seconds.</p>
          </div>

          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-5">
              <div className="space-y-2">
                <Label htmlFor="name" className="text-[10px] font-black uppercase tracking-[0.2em] text-primary/60">Full Identity Name</Label>
                <Input
                  id="name"
                  placeholder="e.g. Julian Sharcly"
                  required
                  value={formData.name}
              ...
              <div className="space-y-2">
                <Label htmlFor="email" className="text-[10px] font-black uppercase tracking-[0.2em] text-primary/60">Digital Mail Address</Label>
                <Input
                  id="email"
                  type="email"
                  placeholder="name@sharcly.com"
                  required
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div className="space-y-2">
                  <Label htmlFor="password" className="text-[10px] font-black uppercase tracking-[0.2em] text-primary/60">New Password</Label>
                ...
                <div className="space-y-2">
                  <Label htmlFor="confirmPassword" className="text-[10px] font-black uppercase tracking-[0.2em] text-primary/60">Verify Key</Label>
                  <div className="relative">
                    <Input
                      id="confirmPassword"
            ...
            <div className="pt-4">
               <Button className="w-full h-16 rounded-2xl premium-gradient font-black uppercase tracking-[0.2em] text-xs shadow-2xl shadow-primary/20 group border-none hover:opacity-90" type="submit" disabled={isLoading}>
                 {isLoading ? <Loader2 className="mr-2 h-4 w-4 animate-spin" /> : "Initiate Account Creation"}
               </Button>
            </div>
            ...
            <div className="relative py-4">
              ...
              <div className="relative flex justify-center text-[10px] font-black uppercase tracking-widest leading-none">
                <span className="bg-background px-4 text-foreground/30">Already Managed?</span>
              </div>
            </div>
