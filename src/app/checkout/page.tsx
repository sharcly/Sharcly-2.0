                                 ...
                                 <div className="space-y-6 pt-4">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                                       ...
                                       <div className="md:col-span-2 space-y-2 relative" ref={suggestionsRef}>
                                          ...
                                          {status === "OK" && (
                                             <div className="absolute z-[100] top-full left-0 right-0 mt-2 bg-white rounded-3xl border border-gray-100 shadow-2xl overflow-hidden">
                                                   ...
                                                   {data.map((suggestion) => {
                                                      ...
                                                      return (
                                                         <button
                                                            ...
                                                            className="w-full text-left px-5 py-4 rounded-2xl hover:bg-gray-50 transition-all flex items-start gap-4 group"
                                                         >
                                                            <div className="mt-1 size-8 rounded-full bg-gray-50 flex items-center justify-center flex-shrink-0 group-hover:bg-white transition-colors">
                                                               <MapPin size={14} className="text-[#062D1B]/40" />
                                                            </div>
                                                            <div className="flex flex-col">
                                                               <span className="text-sm font-bold text-[#062D1B]">{main_text}</span>
                                                               <span className="text-[10px] font-medium text-[#062D1B]/40 uppercase tracking-widest mt-0.5">{secondary_text}</span>
                                                            </div>
                                                         </button>
                                                      );
                                                   })}
