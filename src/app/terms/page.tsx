        ...
        <section className="pt-32 pb-24 md:pt-48 md:pb-32 bg-primary/[0.02]">
           <div className="container mx-auto px-6">
              <div className="max-w-3xl">
                <Badge className="bg-accent/10 text-accent border-none font-black text-[10px] uppercase tracking-widest px-4 mb-8">Legal Documentation</Badge>
                <h1 className="text-6xl md:text-8xl font-black tracking-tighter text-primary leading-[0.9] mb-8">
                  TERMS & <br/>
                  <span className="text-accent italic font-serif">CONDITIONS</span>.
                </h1>
              </div>
           </div>
        </section>
