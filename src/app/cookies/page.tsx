...
export default function CookiesPage() {
  return (
    <div className="min-h-screen antialiased" style={{ background: '#040e07', color: '#eff8ee' }}>
      ...
      <section className="relative pt-36 pb-16 overflow-hidden">
        ...
        <div className="container mx-auto px-6 md:px-12 relative z-10 text-center max-w-3xl">
          <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="inline-flex items-center gap-2.5 px-5 py-2 rounded-full mb-8" style={{ backgroundColor: 'rgba(232,197,71,0.08)', border: '1px solid rgba(232,197,71,0.15)' }}>
            <Cookie className="size-3.5" style={{ color: '#E8C547' }} />
            <span className="text-[10px] font-black uppercase tracking-[0.3em]" style={{ color: '#E8C547' }}>Consent Management</span>
          </motion.div>
          ...
          >
            Cookie<br />
            <span className="italic font-serif" style={{ color: 'rgba(239,248,238,0.18)' }}>Preferences</span>
          </motion.h1>
          ...
          <motion.p initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}
            ...
            Learn how we use cookies and manage your preferences for a personalized, secure browsing experience.
          </motion.p>
        </div>
      </section>
      ...
      <section className="container mx-auto px-6 md:px-12 mb-12">
        <div className="max-w-3xl mx-auto">
          <div className="grid grid-cols-3 gap-4">
            {[
              { icon: Cookie, label: "Essential Only" },
              { icon: ToggleRight, label: "Your Control" },
              { icon: Settings, label: "Fully Configurable" },
            ].map((item, idx) => (
              <motion.div
                key={item.label}
      ...
      <section className="container mx-auto px-6 md:px-12 pb-32">
        ...
        >
          <div className="px-8 py-5 flex items-center justify-between" style={{ borderBottom: '1px solid rgba(239,248,238,0.05)' }}>
            <span className="text-[10px] font-black uppercase tracking-[0.25em]" style={{ color: '#E8C547' }}>Cookie Policy</span>
            <span className="text-[10px] font-bold uppercase tracking-wider" style={{ color: 'rgba(239,248,238,0.2)' }}>Managed via Termly</span>
          </div>

          <div className="p-6 md:p-10 min-h-[600px] cookies-embed-container">
            <div 
      ...
      <style jsx global>{`
        .cookies-embed-container iframe {
