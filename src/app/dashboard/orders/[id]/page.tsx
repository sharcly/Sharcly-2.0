                      ...
                      <>
                        <div className="space-y-4 relative z-10">
                          <div className="flex justify-between items-center">
                            <span className="text-[10px] font-black uppercase tracking-[0.25em] text-white/90">Items Subtotal</span>
                          ...
                          <div className="flex justify-between items-center">
                            <span className="text-[10px] font-black uppercase tracking-[0.25em] text-white/90">Tax (Vat)</span>
                            <span className="font-bold text-sm tabular-nums text-white/90">${tax.toFixed(2)}</span>
                          </div>
                          <div className="flex justify-between items-center">
                            <span className="text-[10px] font-black uppercase tracking-[0.25em] text-white/90">Shipping</span>
