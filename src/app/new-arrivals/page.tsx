  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        // For demonstration, we'll just take the latest 4 products
      ...
      <main className="pt-32 pb-40">
        <section className="container mx-auto px-6 mb-24">
          <div className="max-w-4xl">
            ...
            >
              <span className="text-[10px] font-black uppercase tracking-[0.4em] opacity-40">The Latest Sequence</span>
            ...
            >
              NEW <br />
              <span className="italic font-serif opacity-30">ARRIVALS.</span>
            </motion.h1>
            ...
            >
              Freshly synthesized botanical blends for your modern lifestyle. Experience the cutting edge of wellness.
            </motion.p>
          </div>
        </section>
