...
export default function BestsellersPage() {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        // For demonstration, we'll just take some products as bestsellers
  ...
  return (
    <div className="min-h-screen bg-white text-[#0d2719] selection:bg-[#0d2719] selection:text-white">
      <Navbar />
      ...
      <main className="pt-32 pb-40">
        <section className="container mx-auto px-6 mb-24">
          <div className="max-w-4xl">
            ...
            >
              <span className="text-[10px] font-black uppercase tracking-[0.4em] opacity-40">The Community Favorites</span>
            ...
            >
              BEST <br />
              <span className="italic font-serif opacity-30">SELLERS.</span>
            </motion.h1>
            ...
            >
              Our most-loved essentials, proven by thousands to enhance the daily rhythm of life.
            </motion.p>
          </div>
        </section>
