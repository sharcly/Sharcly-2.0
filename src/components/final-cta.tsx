  ...
  return (
    <section className="relative py-20 lg:py-32 px-6 text-center overflow-hidden bg-[#040e07] text-[#eff8ee]">
      ...
      <div className="relative z-10 max-w-4xl mx-auto">
        ...
        >
          <Link href="/products" className="w-full sm:w-auto px-8 py-4 rounded-full bg-[#E8C547] text-[#082f1d] text-[12px] font-bold uppercase tracking-widest hover:bg-[#f0cf55] transition-all duration-300 shadow-[0_10px_30px_rgba(232,197,71,0.3)] hover:-translate-y-1 flex items-center justify-center gap-2">
            Explore Products
